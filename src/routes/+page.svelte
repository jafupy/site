...
<section
  id="sections.hero"
  class="flex flex-col justify-center h-screen w-screen p-8 gap-5">
  <h3 class="">Hey, I am</h3>
  <h1 class="">{Jacob}</h1>
  <h3 class="">
    {Math.random() < 0.99
      ? "A professional Apple Sheep"
...
<section id="sections:about">
  ...
  <p>
    I'm Jacob, a professional apple sheep with a passion for web development.
